<div id="forms12" class="modal">
	<div class="modal-dialog form-small">
		<a href="#" class="icon-close-popup"></a>
		<h2>Заказать абонентское обслуживание </h2>
...
<div id="forms12-thanks" class="modal">
...
<script>
	...
	$("#order-call").click(function(e) {
		...
		$("#forms12").addClass("modal-open");
	});

	$("#forms12 .blue-btn").click(function(e) {
		e.preventDefault();
		var validated;
		...
		if (validated == 1) {
			...
			closePopup();
			$("body").addClass("hidden");
			$("#forms12-thanks").addClass("modal-open");
		}
	});	
</script>